...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 40, 330, 440));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/instagram.jpg"))); // NOI18N
        jLabel3.setText("caseu_pe");

        jLabel4.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/facebook.jpg"))); // NOI18N
        jLabel4.setText("CASE Ü - Perú");
    ...
    private void Login(){
        if (!txtUsuario.getText().isEmpty() && !txtClave.getText().isEmpty()) {
            ...
            us.setClave(txtClave.getText().trim());
